...
public class RulesetController {
    ...
    @CrossOrigin(origins = {"http://host.docker.internal:9004", "http://host.docker.internal:9030", "http://host.docker.internal:9005", "http://host.docker.internal:9010"})
    ...
    @CrossOrigin(origins = {"http://host.docker.internal:9004", "http://host.docker.internal:9005"})
    ...
    @CrossOrigin(origins = {"http://host.docker.internal:9004", "http://host.docker.internal:9004/ruleset"})
    ...
    @CrossOrigin(origins = "http://host.docker.internal:9004")
    ...
    @CrossOrigin(origins = {"http://host.docker.internal:9030", "http://host.docker.internal:9004"})
